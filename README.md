...
## 👋 소개
- 파이썬 기반 AI·백엔드 개발을 중심으로 LLM 기능을 설계하고 구현합니다.
- RAG, 임베딩, 벡터 검색, API 개발 등 서비스 전 과정을 직접 구축해봤으며, 실제 문제 해결에 초점을 둡니다.
- 인프라 엔지니어 경험을 기반으로 AI 서비스의 안정적 운영·배포와 시스템 수준 이해를 강점으로 가져갑니다.
- 새로운 기술을 빠르게 실험하고 구조화하는 것을 선호하며, 작은 PoC를 빠르면서도 정확하게 구현해 확장하는 스타일입니다.
- 인프라에서 출발해 현재는 LLM 기반 서비스 개발과 AI 백엔드를 주 분야로 전환해 전문성을 구축하고 있습니다.
