...
## 👋 소개
- 파이썬 기반 AI·백엔드 개발을 중심으로 LLM 기능의 설계와 구현에 집중하고 있습니다.
- RAG, 임베딩, 벡터 검색, API 개발 등 LLM 서비스 전 과정을 직접 구축해 경험을 쌓아왔습니다.
- 인프라 엔지니어 경험을 바탕으로 안정적인 운영·배포와 시스템 관점의 구조 이해에 익숙합니다.
- 새로운 기술을 빠르게 실험하고 PoC를 만들어 개선하는 방식으로 개발하는 편입니다.

## 🔨 기술 스택
1. AI/Backend (Primary)<br>
